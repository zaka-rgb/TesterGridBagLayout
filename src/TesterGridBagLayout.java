...
/* insets définir la marge entre les composant new
* Insets(margeSupérieure, margeGauche, margeInférieur, margeDroite)
*/
gc.insets = new Insets(5, 5, 5, 5);
/*
* La propriété anchor permet de spécifier un point d'ancrage à un
* composant à l'intérieur de sa (ou ses) cellule(s)
*/
...
gc.gridy = 1;
/*
* On peut définir un composant qui prend plusieurs cases à l'aide de
* gridwidth
*/
gc.gridwidth = 2;
