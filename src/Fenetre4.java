...
public Fenetre4(String titre)
 ...
 if(source == pre) pile.previous(panneau1);
 if(source == suiv) pile.next(panneau1);
 if(source == prem) pile.first(panneau1);
 if(source == der) pile.last(panneau1);
 }
 
 
 public static void main (String [] args)
 {
 JFrame f = new Fenetre4("Mise en forme : SMI-S6-2015");
 f.setVisible(true);
 }
 }